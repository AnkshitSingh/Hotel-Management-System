...
class Cust_Win:
    def __init__(self, root):
        ...
        # ===============title==================
        Ibl_title=Label(self.root,text="ADD CUSTOMER DETAILS",font=("times new roman",18,"bold"),bg="black",fg="gold",bd=4,relief=RIDGE)
        ...
        # ===============label and entrys=============
        # cust ref
        Ibl_cust_ref=Label(labelframeleft,text="Customer Ref",font=("times new roman",12,"bold"),padx=2,pady=6)
        ...
        combo_id["value"]=("AdharCard", "DrivingLicence", "Passport", "PanCard")
        combo_id.current(0)
